...
from datautils import build_HDF5_feat_dataset_, H5ClassificationDataset
...
def main():
    ...
    # train_data, val_data, test_data = build_HDF5_feat_dataset_(os.path.join(conf.data_dir, 'bracs_patch_feats_pretrain_%s.h5'%conf.pretrain), conf)
    train_data, val_data, test_data = build_HDF5_feat_dataset_(os.path.join(conf.data_dir, 'patch_feats_pretrain_%s.h5'%conf.pretrain), conf)
