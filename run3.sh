...
CUDA_VISIBLE_DEVICES=0 python Step3_WSI_classification_MYMIL_2_featrue.py --wandb_mode offline --arch ga \
                                                                --n_token 10 --n_drop 0 --temp 0.5 \
                                                                --pretrain medical_ssl \
                                                                --config config/rcc_medical_ssl_config.yml >> RCC_medical_ssl_config_mymil.txt
...
CUDA_VISIBLE_DEVICES=0 python Step3_WSI_classification_MYMIL_2_featrue.py --wandb_mode offline --arch ga \
                                                                --n_token 4 --n_drop 2 --temp 0.5 \
                                                                --pretrain medical_ssl \
                                                                --config config/rcc_medical_ssl_config.yml >> RCC_medical_ssl_config_mymil.txt

CUDA_VISIBLE_DEVICES=0 python Step3_WSI_classification_MYMIL_2_featrue.py --wandb_mode offline --arch ga \
                                                                --n_token 4 --n_drop 1 --temp 0.5 \
                                                                --pretrain medical_ssl \
                                                                --config config/rcc_medical_ssl_config.yml >> RCC_medical_ssl_config_mymil.txt


CUDA_VISIBLE_DEVICES=0 python Step3_WSI_classification_MYMIL_2_featrue.py --wandb_mode offline --arch ga \
                                                                --n_token 10 --n_drop 4 --temp 0.2 \
                                                                --pretrain medical_ssl \
                                                                --config config/rcc_medical_ssl_config.yml >> RCC_medical_ssl_config_mymil.txt

CUDA_VISIBLE_DEVICES=0 python Step3_WSI_classification_MYMIL_2_featrue.py --wandb_mode offline --arch ga \
                                                                --n_token 10 --n_drop 2 --temp 0.2 \
                                                                --pretrain medical_ssl \
                                                                --config config/rcc_medical_ssl_config.yml >> RCC_medical_ssl_config_mymil.txt

CUDA_VISIBLE_DEVICES=0 python Step3_WSI_classification_MYMIL_2_featrue.py --wandb_mode offline --arch ga \
                                                                --n_token 10 --n_drop 6 --temp 0.2 \
                                                                --pretrain medical_ssl \
                                                                --config config/rcc_medical_ssl_config.yml >> RCC_medical_ssl_config_mymil.txt
...
CUDA_VISIBLE_DEVICES=0 python Step3_WSI_classification_MYMIL_2_featrue.py --wandb_mode offline --arch ga \
                                                                --n_token 8 --n_drop 2 --temp 0.2 \
                                                                --pretrain medical_ssl \
                                                                --config config/rcc_medical_ssl_config.yml >> RCC_medical_ssl_config_mymil.txt

CUDA_VISIBLE_DEVICES=0 python Step3_WSI_classification_MYMIL_2_featrue.py --wandb_mode offline --arch ga \
                                                                --n_token 4 --n_drop 2 --temp 0.2 \
                                                                --pretrain medical_ssl \
                                                                --config config/rcc_medical_ssl_config.yml >> RCC_medical_ssl_config_mymil.txt

CUDA_VISIBLE_DEVICES=0 python Step3_WSI_classification_MYMIL_2_featrue.py --wandb_mode offline --arch ga \
                                                                --n_token 4 --n_drop 1 --temp 0.2 \
                                                                --pretrain medical_ssl \
                                                                --config config/rcc_medical_ssl_config.yml >> RCC_medical_ssl_config_mymil.txt
                                                                

CUDA_VISIBLE_DEVICES=0 python Step3_WSI_classification_MYMIL_2_featrue.py --wandb_mode offline --arch ga \
                                                                --n_token 16 --n_drop 8 --temp 0.2 \
                                                                --pretrain medical_ssl \
                                                                --config config/rcc_medical_ssl_config.yml >> RCC_medical_ssl_config_mymil.txt


CUDA_VISIBLE_DEVICES=0 python Step3_WSI_classification_MYMIL_2_featrue.py --wandb_mode offline --arch ga \
                                                                --n_token 16 --n_drop 12 --temp 0.2 \
                                                                --pretrain medical_ssl \
                                                                --config config/rcc_medical_ssl_config.yml >> RCC_medical_ssl_config_mymil.txt
