...
def main():
    ...
    ckpt_pth = os.path.join(args.ckpt_folder, 'checkpoint-best.pth')
    ...
    # breakpoint()
    h5_data = h5py.File('/fs2/comm/kpgrp/yelinfen/Documents/CLAM/TCGA_Lung_feature/H5/LUAD_h5_files/TCGA-05-4244-01Z-00-DX1.d4ff32cd-38cf-40ea-8213-45c2b100ac01.h5', 'r')
